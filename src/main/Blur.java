...
public class Blur {
	...
	private static void blurFile(String filename, int numIterations) {
		...
		/*
		 * TIFFEncoder.writeTIFF(new RunLengthEncoding(edges), "rle" +
		 * blurname);
		 */
	 ...
	 * optional second argument is number of iterations of blurring.
	 *
	 * @param args
		...
		if (args.length == 0) {
			...
			System.out
					.println("  interations is the number of blurring iterations"
							+ " (default 1).");
			System.out
					.println("The blurred image is written to blur_imagefile.");
			System.exit(0);
		}
