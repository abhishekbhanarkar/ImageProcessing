...
public class Sobel {
	 ...
	 *
	 * @param filename
	 *            the name of the input TIFF image file.
	 * @param numIterations
	 *            the number of iterations of blurring to perform.
	 * @param rle
	 *            true if the output TIFF file should be run-length encoded.
	 */
	 ...
	 *
	 * The first command-line argument is the name of the image file. An
	 * optional second argument is number of iterations of blurring. An optional
	 * third argument triggers the writing of a run-length encoded
	 * grayscale-edge image.
	 *
	 * @param args
	 *            the usual array of command-line argument Strings.
	 */
		...
		if (args.length == 0) {
			...
			System.out
					.println("  interations is the number of blurring iterations"
							+ " (default 0).");
			System.out
					.println("  any third argument (RLE) turns on run-length "
